...
{
    public static async ValueTask<Page<T>> GetPagedAsync<T>(this IQueryable<T> queryable, int pageSize, int page)
    {
    ...
    public static async ValueTask<Page<T>> GetPagedAsync<T>(this ValueTask<IQueryable<T>> queryableTask, int pageSize, int page)
    {
